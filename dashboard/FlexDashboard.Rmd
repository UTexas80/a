...
```{r rdsInput}
dt_abc_profit             <- readRDS(here::here("rds", "dt_abc_profit.rds"))
...
renderPlot({
  x <- tk_xts(price())
  chartSeries(x, theme = 'black',subset = '2001::', TA = "addBBands();addVo();addCMF();addZLEMA()")   #Year 2016 To Present
})
...
```{r 2.2.2.3-table-goldenx, eval=trend}
